  ...
  return (
    <View style={styles.tabbarView}>
      <Image
        ...
        style={{    width: focused ? vw(28) : vw(25), 
...
const BottomTabNavigator = () => {
  return (
    <Tab.Navigator
      screenOptions={({ route }) => ({
        tabBarStyle: { backgroundColor: 'white', height: Platform.OS === "ios"?vh(70): vh(50), paddingTop: vh(10) },
    ...
    >
      ...
      <Tab.Screen name="Saved" component={Saved} options={{ headerShown: true }} />
